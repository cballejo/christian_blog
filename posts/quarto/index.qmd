...
subtitle: "Serie Quarto"
author: "Christian Ballejo"
date: "2026-07-31"
categories: [R, Quarto]
image: "bienvenidxs.png"
---
...
Los documentos de Quarto son totalmente reproducibles y admiten distintos  formatos de salida, como archivos HTML, PDF, Word, presentaciones y más.
...
Su sitio web es <https://quarto.org/> y el acceso a la descarga ese encuentra en [Get Started](https://quarto.org/docs/get-started/). Una vez descargado el ejecutable su instalación es sencilla y similar a cualquier aplicación de Windows.
...
![](esqueleto.PNG){fig-align="center" width="700"}
...
![](navegacion.PNG){fig-align="center" width="700"}
...
![](sidebar.PNG){fig-align="center" width="150"}
...
![](layout2.PNG){fig-align="center" width="600"}
...
![](layout3.PNG){fig-align="center" width="600"}
...
![](layout4.PNG){fig-align="center" width="600"}
...
![](layout1.PNG){fig-align="center" width="600"}
...
![](valuebox.PNG){fig-align="center" width="250"}
...
![](basic-widgets.png){fig-align="center" width="700"}
...
En septiembre de 2026 Posit iniciará un proceso de migración hacia el nuevo Posit Connect Cloud y dispondrá de una herramienta para que cada usuario lo realice. Entre enero y junio de 2027 la migración será automática de los respositorios que aun no lo hayan hecho. Luego el sitio quedará en desuso.
